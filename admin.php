...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $admin_id = random_num(11);
    $query = "insert into admins (admin_id,adminname,adminemail,adminpass) values ('$admin_id','$adminname','$adminemail','$adminpass') ";
...
<body>
    <form method="post">
        <h1><i class="fa fas fa-user"></i> Assign New Admin</h1>
